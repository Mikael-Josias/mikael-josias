...
const projects = [
  {
    ...
    name: "Portfolio",
    descrition: "this website seeks showcase my works, skills and experience as a developer.",
    tags: [
      "React",
      "TypeScript",
      "TailWindCSS",
          ...
          return (
            <div key={i} className="flex flex-col gap-2 w-full md:w-[calc(50%-20px)] pb-5 border-b-[1px] border-b-black/25 dark:border-b-white/25">
              ...
              <div className="flex gap-1.5 mb-3 flex-wrap">
                {p.tags?.map((t, i) => {
                  return (
                    <span key={i} className="p-1.5 text-white bg-moss-500 text-xs font-normal rounded-md">
                      {t}
                    </span>
                  )
                })}
              ...
              {p.siteUrl !== "" && p.githubUrl !== "" ?
                <div className="flex gap-1.5 w-full">
                  {p.siteUrl !== "" ?
                    <a href={p.siteUrl} target="_blank" className="flex items-center justify-center gap-1.5 p-1.5 rounded-md bg-white text-black text-xs font-normal">
                  ...
                  {p.githubUrl !== "" ?
                    <a href={p.githubUrl} target="_blank" className="flex items-center justify-center gap-1.5 p-1.5 rounded-md bg-black text-white text-xs font-normal" >
                      <img src={GitHubLight} alt="white github logo" className="size-3.5" />
                      repo
                    </a> :
                    <></>
                  }
